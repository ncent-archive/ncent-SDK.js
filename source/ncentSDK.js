...
class ncentSDK {
    ...
    async createChallenge(senderKeypair, name, description, imageUrl, participationUrl, expiration, tokenTypeUuid, rewardAmount, rewardType, maxShares, maxRedemptions) {
        const messageObj = {
            rewardAmount,
            name,
            description,
