...
class ncentSDK {
    ...
    */
    async stampToken(publicKey, tokenName, numTokens, expiryDate) {
      return (
        await axios.post(`${this._net}/tokentypes`, {
    ...
    */
    async transferTokens(senderKeyPair, receiverPublic, tokentypeId, tokenAmount) {
        ...
        return (
          await axios.post(`${this._net}/tokentypes/${tokentypeId}/items`, {
              amount: tokenAmount,
              fromAddress: senderKeyPair.publicKey(),
              toAddress: receiverPublic,
              signed
    ...
    */
    async getTokenBalance(publicKey, tokenTypeUUID) {
      return (
        await axios.get(`${this._net}/wallets/${publicKey}/${tokenTypeUUID}`)
      );
    }
    ...
    (string) publicKey: The wallet publicKey
    */
    async getAllBalances(publicKey) {
      return (
        await axios.get(`${this._net}/wallets/${publicKey}`, {})
      );
    }
...
/*
DEPRECATED CODE / FUTURE IMPLEMENTATIONS
